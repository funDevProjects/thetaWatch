		...
		<script>
			...
			function appChartery(fetchChart = false)
			{
				...
				var myObject 		= new Object();
					myObject.action = new Object();
					myObject.action.destination_container_id = "guards";
					
					myObject.params = new Object();
					myObject.params.range_start = range_start;
					myObject.params.range_end = range_end;
					myObject.params.range_increment = range_increment;
					myObject.params.range_withdrawals = range_withdrawals;
					
				var data 			= JSON.stringify(myObject);
				
				<?php /* console.log(range_withdrawals); */ ?>
				...
				$.ajax({
					...
					success: 		function(data)
					{
					   ...
					   {
							var payload_G		= JSONObject.result.result.data;
						    
							<?php /* IF DATA RETURNED, SET VARIABLES & INITIAL CONDITIONS */ ?>
							var plotY 				= [];
							var plotX 				= [];
							var plotXY				= [];
							var plotWD				= [];
